<template>
  ...
  return expenseTransactions.value
    .filter(t => {
      ...
      if (isCurrentMonth) {
        console.log('Current month expense found:', t.description, t.amount, transactionDate.toDateString())
      }
...
const lastMonthExpenses = computed(() => {
  ...
  return expenseTransactions.value
    .filter(t => {
      ...
      if (isLastMonth) {
        console.log('Last month expense found:', t.description, t.amount, transactionDate.toDateString())
      }
